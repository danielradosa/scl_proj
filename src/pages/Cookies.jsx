  ...
  return (
    <>
      ...
      <div className="grid w-[960px] text-center">
        <p>
          Cookie Policy for SOCIALink <br />
          ...
          <br />
          The Cookies We Set <br /> Login related cookies We use cookies when
          you are logged in so that we can remember this fact. This prevents you
          ...
          remember your user details for future correspondence. Site preferences
          cookies In order to provide you with a great experience on this site
          we provide the functionality to set your preferences for how this site
          ...
          interact with a page is affected by your preferences. Third Party
          Cookies In some special cases we also use cookies provided by trusted
          ...
          including; , will set cookies through our site which may be used to
          ...
          Policy article. However if you are still looking for more information
          then you can contact us through one of our preferred contact methods:
          Email: info.beeam@gmail.com Generated using Cookies Policy Generator
        </p>
      </div>
    </>
  );
