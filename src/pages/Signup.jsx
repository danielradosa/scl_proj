...
const SIGNUP_MUTATION = gql`
    mutation register ($email: String!, $password: String!, $handle: String!, $username: String!, $role: String!) {
        register (email: $email, password: $password, handle: $handle, username: $username, role: $role) {
            id
            email
            handle
            username
...
const Signup = () => {
    ...
    return <div className="login">
        ...
        <form onSubmit={handleSubmit}>
            ...
            <input type="password" placeholder="Confirm Password" value={passwordC} onChange={(e) => setPasswordC(e.target.value)} /> <br />
            <input type="text" placeholder="Handle" value={handle} onChange={(e) => setHandle(e.target.value)} /> <br />
